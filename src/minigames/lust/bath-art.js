...
const BATH_ART = {
    ...
    // Хвост НАЧИНАЕТ маленьким и сильно растёт: в этом весь этап. Прежние
    // 170×68 были размером с голову червя уже до всякого роста, и расти ему
    // было некуда — а выросший до полутора голов он делал попадание в рот
    // почти невозможным: кончик задирался выше цели.
    TAIL: { len: 145, base: 40, seg: 22, side: 1 },
