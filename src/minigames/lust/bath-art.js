...
const BATH_ART = {
    ...
    FOCUS: {
        ...
        overview: { x: 20, y: 55, w: 750, h: 790 },
        // Мытьё: в кадре обязаны быть и червь, и полка, и душ. Полка уехала
        // выше и правее головы, душ вырос — кадр пришлось расширить.
        body:     { x: 50, y: 145, w: 740, h: 545 },
        // Хвост всплывает у ближнего борта. Кадр держит ДУГУ, по которой
        // полетит струя: от корня хвоста до рта. Раньше он был шире на всю
        // ванну, и сам хвост — то, чем игрок работает — оказывался прижат к
        // правому краю и наполовину за рамкой.
        tail:     { x: 285, y: 225, w: 400, h: 480 },
        // Финал: голова червя и хвост одновременно.
        finish:   { x: 285, y: 225, w: 400, h: 480 }
    },
