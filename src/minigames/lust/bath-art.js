...
const BATH_ART = {
    ...
    FOCUS: {
        ...
        tail:     { x: 160, y: 306, w: 294, h: 400 },
        // Финал: в кадре обязаны быть и кончик хвоста, и рот — между ними
        // летит струя.
        // Финал: в кадре обязаны быть и кончик хвоста, и рот — между ними
        // летит струя. Плечо стало вдвое короче, и кадр поджался следом.
        finish:   { x: 170, y: 380, w: 390, h: 430 }
    },
    ...
    TAIL: { len: 170, base: 68, seg: 22, side: 1 },
