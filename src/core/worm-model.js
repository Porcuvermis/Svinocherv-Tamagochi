...
// ПОСЛЕ живота, на растущих сегментах). Бампнута специально, чтобы у
// игроков, тестирующих через сохранённое в localStorage состояние,
// загрузился новый дефолт (mergeWormOverride/loadWormModel сбрасывает на
// createDefaultWormModel(), если версия не совпадает) — иначе смена одной
// лишь константы никак не проявилась бы на уже сохранённом персонаже.
const WORM_MODEL_VERSION = 2;
