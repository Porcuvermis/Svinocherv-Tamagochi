...
// никогда.
//
// «Сужение» при этом бесплатное: широкие ступени края стираются РАНЬШЕ
// узкого тела, и хвост следа сам сходит на нет. Числа ниже — это возраст
// слизи (мс), в котором пропадает соответствующий слой. Полная жизнь — две
